import fs from 'fs';
import type { ResponseLike } from '@paxeer-network/paxeer-governance-sdk/internal/to-file';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@paxeer-network/paxeer-governance-sdk/core/uploads');
    await expect(
